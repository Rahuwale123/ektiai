    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-[#F9FAFB]">
      ...
      >
        ...
        <p className="text-[#666666] text-center mb-12 font-medium">
          Sign in to start your session with Mia.
        </p>

        <button
          onClick={onLogin}
          className="w-full flex items-center justify-center gap-4 py-5 px-8 rounded-full border border-gray-100 bg-white hover:bg-gray-50 hover:border-gray-200 transition-all active:scale-[0.98] shadow-sm group"
        >
        ...
        <p className="mt-12 text-xs text-gray-400 text-center leading-relaxed">
          ...
          <a href="#" className="underline hover:text-gray-600 font-medium">Terms of Service</a> and <a href="#" className="underline hover:text-gray-600 font-medium">Privacy Policy</a>.
        </p>
      </motion.div>
    </div>
  );
